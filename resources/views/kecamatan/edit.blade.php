    ...
    <div class="row">
        <div class="tile col-12 mb-4">
            <div class="page-header">
              <div class="row">
                <div class="col-lg-12">
                <h2 class="mb-3 line-head" id="buttons">Edit Kecamatan</h2>
                </div>
              </div>
            </div>
            <div class="row">
                <form action="{{ route('kecamatan.update', $kecamatan->id) }}" method="POST" class="col-12">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" value="{{ $kecamatan->nama_wilayah }}"  type="text"  placeholder="Masukkan Nama wisat , ex : Banjar" name="nama_wilayah">
                    </div>
